...
// 从环境变量读取各模块 Base URL
// /api/little-note
const LITTLE_NOTE_BASE_URL = import.meta.env.VITE_API_URL;
// /api/user-center
const USER_CENTER_BASE_URL = import.meta.env.VITE_USER_CENTER_API_BASE_URL;
// /api/sys
const SYS_BASE_URL = import.meta.env.VITE_SYS_API_URL;
// /api/oss
const OSS_BASE_URL = import.meta.env.VITE_UPLOAD_BASE_URL;
